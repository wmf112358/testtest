...
class CaseListPage(QWidget):
    ...
    def add_case_row(self):
        ...
        btn_delete.setProperty("row", i)
        btn_delete.clicked.connect(self.handle_delete_clicked)
    ...
    def update_case_table(self):
        ...
        for i, case in enumerate(self.case_list_data):
            ...
            item_name.setToolTip(case["name"])  # 鼠标悬停显示全部内容
            self.table.setItem(i, 1, item_name)
            # 更新时间列居中
